...
def get_args_parser():
    ...
    parser.add_argument('--vis_loss', action='store_true',
                        help="Whether train the visible loss")
    parser.add_argument('--contrastive', action='store_true',
                        help="Whether train the contrastive loss")
    # * Matcher
    parser.add_argument('--set_cost_class', default=2, type=float,
                        help="Class coefficient in the matching cost")
    parser.add_argument('--set_cost_vis', default=2, type=float,
                        help="Visiblity coefficient in the matching cost")
    ...
    parser.add_argument('--vis_loss_coef', default=2, type=float)
    ...
    # dataset parameters
    # ['ytvos', 'davis', 'a2d', 'jhmdb', 'refcoco', 'refcoco+', 'refcocog', 'all', 'mevis']
    ...
    parser.add_argument('--email', default=False, action='store_true', help='whether visualize the masks during inference')
    ...
    # model variation
    parser.add_argument('--qtrans', action='store_true', help='using query transformer in decoder')
    parser.add_argument('--keep_fps', action='store_true', help='keep the fps static when sampling')
    parser.add_argument('--vid_aug', action='store_true')
    parser.add_argument('--pretrain_enc', action='store_true')
    parser.add_argument('--pretrain_coco', action='store_true', help='pretrain the model on coco based pesudo-video clips')
    parser.add_argument('--f_token', default=0, type=int, help='using frame token in encoder')
    parser.add_argument('--vlblock', action='store_false', help='skip the vision language block')

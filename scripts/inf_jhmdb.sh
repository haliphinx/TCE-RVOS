...
python main.py --dataset_file jhmdb --with_box_refine \
--freeze_text_encoder --batch_size 1 --ngpu 1 --qtrans --f_token 8 \
--resume /home/xhu/Code/narval_ref/ytvos_dirs/a2d_res/vss/checkpoint.pth \
--backbone video_swin_s_p4w7  --eval